...
class BluezThread(JNTBusThread):
    """The I2C thread
    ...
    def init_bus(self):
        """Build the bus
        """
        from janitoo_bluez.bus_bluez import BluezBus
        self.section = OID
        self.bus = BluezBus(options=self.options, oid=self.section, product_name="Bluetooth bus")
